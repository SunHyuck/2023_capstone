...
namespace SysCtrl
{
    ...
    void CalibrationCtrl::setCalibration(int type, const std::vector<int> &cal)
    {
        ...
        if (cal[ServoCalType::max] == cal[ServoCalType::min] || cal[ServoCalType::max] == cal[ServoCalType::mid] || cal[ServoCalType::min] == cal[ServoCalType::mid] || std::max(cal[ServoCalType::max], cal[ServoCalType::min]) != cal[ServoCalType::max] || std::max(cal[ServoCalType::max], cal[ServoCalType::mid]) != cal[ServoCalType::max] || std::max(cal[ServoCalType::min], cal[ServoCalType::mid]) != cal[ServoCalType::mid])
        {
